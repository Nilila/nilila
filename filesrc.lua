...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>nilila chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "nilila", HidePremium = false, IntroText = "nilila⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("nilila SCRIPT")
W:AddLabel("Discordnilila")
local Section = W:AddSection({
    Name = "Status"
})
